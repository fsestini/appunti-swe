...
\begin{itemize}
	\item Documentazione: serve uno strumento che renda i requisiti oggettivi, discutibili (oggetto plausibile di discussione) e non ambigui (uso diagrammi e glossario). La poca narrazione associata ai diagrammi deve essere di supporto, tecnica e sintetica, e appoggiarsi a un glossario per eliminare l'ambiguità dei termini.
		\begin{itemize}
